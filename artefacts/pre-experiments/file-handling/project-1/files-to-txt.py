...
java_filenames = ["TitlePage.java", "PreGameSelection.java", "GameTimer.java",
                  "SinglePlayer.java", "SinglePlayerModel.java", "PostGameScreen.java"]

# Path to the directory you want to search
root_dir = '/home/shariq/lts/thesis/replication-package/Models vs. Code/Version(s) of Source Code Used/1_ZooTypers-7591f15/ZooTypers/src/com/example/zootypers'

# Output file to append the filenames
output_file = 'p1-files.txt'
